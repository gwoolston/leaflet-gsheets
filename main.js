...
let geomURL =
  "https://docs.google.com/spreadsheets/d/e/2PACX-1vQOPeHbGxkf91D3OJMJIyVKkKeWTIntYIOO4quh17AGJBdMAHhdXada__LVEMNq_ZtFgjwLUwS18qIx/pub?output=csv";
let pointsURL =
...
function init() {
  ...
  map = L.map("map").setView([36.959583129994385, -122.03835298409595], 12);
...
function addGeoms(data) {
  ...
  let geomStyle = { color: "#2ca25f", fillColor: "#99d8c9", weight: 0 };
  let geomHoverStyle = { color: "green", fillColor: "#2ca25f", weight: 0 };
